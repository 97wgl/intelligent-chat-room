...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/gh/xiangyuecn/Recorder@1.1.21021500/recorder.wav.min.js"></script>

    <!-- 引入可选的扩展支持项，如果不需要这些扩展功能可以不引入 -->
...
<ul class="layui-nav layui-bg-blue">
    ...
    <li class="layui-nav-item mobile-none">智慧课堂</li>
...
<script>
    ...
    function recStop(type) {
        ...
        rec.stop(function (blob, duration) {
            ...
            if (type) {
                recPlay();
                // CHAT.sendTextTool(recBlob);
                var formData = new FormData();
                formData.append("wavFile", recBlob);
                $.ajax({
                    type: 'POST',
                    url:'/speech/asr',
                    data: formData,
...
/*        var reader = new FileReader();
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("POST", api);
        xhr.onreadystatechange = onreadystatechange("【FormData】上传");
        xhr.send(form);
    };
